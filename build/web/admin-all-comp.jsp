...
<%@ page import="Dbconn.dbconn"%>
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pending /</span> Companies</h4>
...
//    String sql = "SELECT * FROM company where status='Accepted' ";
String sql = "SELECT * FROM company WHERE status IN ('Accepted', 'Rejected')";
...
%>
    ...
    while (resultSet.next()) {
     ...
     byte[] companyImageBytes = resultSet.getBytes("cimage");
      ...
      byte[] PanImageBytes = resultSet.getBytes("pimage");
        String PanImageBase64 = Base64.encodeBase64String(PanImageBytes);
        ...
        %>
                  <tbody>
                    <tr>
                      ...
                      <td><a href="assets2/img/documents/<%=resultSet.getString(11)%>" download><textarea rows="1" cols="15" ><%=resultSet.getString(11)%></textarea></a></td>
                      
                      <td><img src="data:image/jpeg;base64,<%= PanImageBase64 %>"  width="50px" height="30px" alt="Company Image"></td>
    ...
    if ("Accepted".equals(status)) {
        ...
        badgeStyle = "background-color: yellow; color: black;";
    }
%>
<td>
    <span class="badge" style="<%= badgeStyle %>">
        <%= status %>
                      ...
                      <!--                     
<td><button type="button" class="btn-xs btn-success">Accept</button>&nbsp;&nbsp;<button
                          type="button" class="btn-xs btn-danger">Decline</button>
                      </td>-->
<td>
    <div class="row">
    <div class="btn-group">
...
<!--            <input type="hidden" name="source" value="companyid"> -->
            <input type="hidden" name="source2" value="companyid"><!-- Specify the source here -->
        ...
        <form action="update-status.jsp" method="post">
            ...
            <input type="hidden" name="source2" value="companyid">
<!--            <input type="hidden" name="source" value="companyid"> Specify the source here -->
