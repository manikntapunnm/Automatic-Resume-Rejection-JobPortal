...
<%@ page import="Dbconn.dbconn"%>
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Candidates /</span> Feedback</h4>
                ...
                <table class="table">
                  <thead>
                    <tr class="text-nowrap">
                      ...
                      <th>hw wuld you rate fr the jb in our site</th>
                      <th>hw wuld you rate to recomend to others</th>
                      <th>hw much you </th>
