...
<!--             <a href="newjsp.jsp">hello</a>-->
          <!-- Dashboard -->
          <li class="menu-item active">
            <a href="admin-index.jsp" class="menu-link">
    ...
    PreparedStatement countApplicationsByStatus = null;
    PreparedStatement countApplications = null;
    PreparedStatement countCandidates = null;
    PreparedStatement countCompanies = null;
    PreparedStatement countJobs = null;
    
    try {
        connection = new dbconn().getConnection();
        
        
        countApplicationsByStatus = connection.prepareStatement(
            "SELECT COUNT(*) FROM applications WHERE application = ?");
        
       
        countApplications = connection.prepareStatement("SELECT COUNT(*) FROM applications");
        countCandidates = connection.prepareStatement("SELECT COUNT(*) FROM candidates");
        countCompanies = connection.prepareStatement("SELECT COUNT(*) FROM company");
        countJobs = connection.prepareStatement("SELECT COUNT(*) FROM jobs");
        
       
        
        ResultSet applicationsCountResult = countApplications.executeQuery();
        ResultSet candidatesCountResult = countCandidates.executeQuery();
        ResultSet companiesCountResult = countCompanies.executeQuery();
        ResultSet jobsCountResult = countJobs.executeQuery();
        
        if (applicationsCountResult.next()) {
            int applicationsCount = applicationsCountResult.getInt(1);

        }
        
        if (candidatesCountResult.next()) {
            int candidatesCount = candidatesCountResult.getInt(1);

        }
        
        if (companiesCountResult.next()) {

        }
        
        if (jobsCountResult.next()) {
            int jobsCount = jobsCountResult.getInt(1);
                  ...
                  <div class="d-flex align-items-end row">
                    ...
                    <div class="col-sm-5 text-center text-sm-left">
                      <div class="card-body pb-0 px-0 px-md-4">
                        <img src="assets2/img/illustrations/man-with-laptop-light.png" height="140"
                      ...
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                            <img src="assets2/img/icons/unicons/chart-success.png" alt="chart success"
                              class="rounded" />
                          </div>
                          <div class="dropdown">
                        ...
                        <h3 class="card-title mb-2"><%= applicationsCountResult.getInt(1) %></h3>
              ...
              <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <h3 class="card-title mb-2"><%= candidatesCountResult.getInt(1) %></h3>
                  ...
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <h3 class="card-title mb-2"><%= companiesCountResult.getInt(1) %></h3>
              ...
              <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <h3 class="card-title mb-2"><%= jobsCountResult.getInt(1) %></h3>
 ...
 String[] applicationStatuses = {"Shortlisted", "Hired", "accepted", "rejected"};
        
        for (String status : applicationStatuses) {
            countApplicationsByStatus.setString(1, status);
            ResultSet resultSet = countApplicationsByStatus.executeQuery();
            
            if (resultSet.next()) {
                int count = resultSet.getInt(1);
//                out.println("Applications with status " + status + ": " + count);
...
<!--                        <span class="fw-semibold d-block mb-1">Shortlisted</span>
...
<!--             <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <span class="fw-semibold d-block mb-1">Hired</span>
                        <h3 class="card-title mb-2">$12,628</h3>
...
<!--              <div class="col-lg-6 col-md-4 order-1">
                  ...
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                            <img src="assets2/img/icons/unicons/wallet-info.png" alt="Credit Card" class="rounded" />
                          </div>
                          <div class="dropdown">
        ...
        if (countApplicationsByStatus != null) countApplicationsByStatus.close();
        if (countApplications != null) countApplications.close();
        if (countCandidates != null) countCandidates.close();
        if (countCompanies != null) countCompanies.close();
        if (countJobs != null) countJobs.close();
                ...
                <div class="card h-100">
                  <div class="card-header">
                    <ul class="nav nav-pills" role="tablist">
                      ...
                      <li class="nav-item">
                        <button type="button" class="nav-link" role="tab">Companies Status</button>
                      </li>
                    </ul>
                  </div>
                    ...
                    <div class="tab-content p-0">
                      <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                        <div class="d-flex p-4 pt-3">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="assets2/img/icons/unicons/wallet.png" alt="User" />
                          </div>
                          <div>
                ...
                <div class="card h-100">
                  ...
                  <div class="card-body">
                    <ul class="p-0 m-0">
                      <li class="d-flex mb-4 pb-1">
                        <div class="avatar flex-shrink-0 me-3">
                          <img src="assets2/img/icons/unicons/paypal.png" alt="User" class="rounded" />
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                      ...
                      <li class="d-flex mb-4 pb-1">
                        <div class="avatar flex-shrink-0 me-3">
                          <img src="assets2/img/icons/unicons/wallet.png" alt="User" class="rounded" />
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                      ...
                      <li class="d-flex mb-4 pb-1">
                        <div class="avatar flex-shrink-0 me-3">
                          <img src="assets2/img/icons/unicons/chart.png" alt="User" class="rounded" />
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                      ...
                      <li class="d-flex mb-4 pb-1">
                        <div class="avatar flex-shrink-0 me-3">
                          <img src="assets2/img/icons/unicons/cc-success.png" alt="User" class="rounded" />
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                      ...
                      <li class="d-flex">
                        <div class="avatar flex-shrink-0 me-3">
                          <img src="assets2/img/icons/unicons/cc-warning.png" alt="User" class="rounded" />
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
