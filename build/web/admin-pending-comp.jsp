...
try {
    ...
    String sql = "SELECT * FROM company where status='Pending' ";
...
%>
            ...
            <!-- Responsive Table -->
            <div class="card">
              <h5 class="card-header">Pending Companies</h5>
        ...
        %>
                  <tbody>
                    <tr>
                      ...
                      <td><span class="badge  bg-label-primary me-1"><%=resultSet.getString(12)%></span></td>
...
if (status.equals("Accepted")) {
    ...
    statusColor = "orange"; // Assuming "Pending" status
}
