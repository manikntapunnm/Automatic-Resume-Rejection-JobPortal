...
<%@ page import="Dbconn.dbconn"%>
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">View /</span> Candidates</h4>
...
try {
    ...
    PreparedStatement countStatement = connection.prepareStatement("SELECT COUNT(*) FROM candidates");
    ...
    // Fetch candidate information using LIMIT
   ...
   int sNo = 1;
    while (resultSet.next()) {
     ...
     byte[] ImageBytes = resultSet.getBytes("image");
        String companyImageBase64 = Base64.encodeBase64String(ImageBytes);
        ...
        %>
                  <tbody>
                   ...
                   <td><img src="data:image/jpeg;base64,<%= companyImageBase64 %>"  width="50px" height="30px" alt=""></td>
