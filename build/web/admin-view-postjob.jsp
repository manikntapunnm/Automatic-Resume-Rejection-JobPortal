      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">View /</span> Jobs Details</h4>
...
try {
    ...
    // Your code to display job postings and related information
%>
...
try {
    ...
    while (resultSet.next()) {
        ...
        %>  
            ...
            <td><%= officialEmail %></td>
            <td><textarea rows="2" cols="19"><%= Description %></textarea></td>
            <td><button type="button" class="btn-xs btn-primary"> <a href="admin-viewde-jb.jsp"
