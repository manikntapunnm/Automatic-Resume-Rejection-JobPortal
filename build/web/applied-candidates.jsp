      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Applied /</span> Candidates</h4>
...
String apply = (String) session.getAttribute("email");
////out.println(email);
try {
    ...
    while (resultSet.next()) {
      ...
      //  out.println(jobNature);
       ...
       //   out.println(Date);
          ...
          String sta = resultSet.getString("application");
...
<!--                      <td><button type="button" class="btn-xs btn-success">Shortlist</button></td>-->
