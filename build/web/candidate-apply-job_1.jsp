...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row justify-content-center">
            ...
            <div class="col-md-6">
            <form action="candidate-apply-jobaction.jsp" enctype="multipart/form-data" method="post" >
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="resume" class="form-label" >Upload Resume<sub> (.txt files only)</sub></label>
                        ...
                        <div>
                            <button type="submit" class="btn btn-primary justify-content-center"
                                    style="border-radius:25px;"> Apply</button>
                        </div>
                   </div><!-- candidate-apply-jobaction.jsp-->
                </div>
            </div>
        </form>
    </div>
...
//    // No need to prevent default submission    id="uploadForm"
//    var formData = new FormData(this);
//    var resumeFile = formData.get('file');
//    
//    var reader = new FileReader();
//    reader.onload = function(event) {
//        formData.append('fileContent', event.target.result);
//    };
//    
//    reader.readAsText(resumeFile);
//});
//
//// No need for a separate function to sendForm
//
//// Redirect to candidate-apply-jobaction.jsp after form submission
//document.getElementById('uploadForm').addEventListener('submit', function(event) {
//    // This line prevents the default form submission
...
//        formData.append('fileContent', event.target.result);
//        
//        fetch('candidate-apply-jobaction.jsp', {
//            method: 'POST',
//            body: formData
//        })
...
//            
//            // Redirect to candidate-apply-jobaction.jsp
//            window.location.href = 'candidate-apply-jobaction.jsp';
//        })
//        .catch(error => {
//            // Handle errors
//        });
...
//        var skills = extractSkills(fileContent);
//        
//        formData.append('fileContent', fileContent);
//        formData.append('skills', skills.join(',')); // Convert skills array to comma-separated string
//        
//        // Update the action URL to include the data as query parameters
//        var actionUrl = 'candidate-apply-jobaction.jsp' +
//            '?fullname=' + encodeURIComponent(formData.get('fullname')) +
//            '&edu=' + encodeURIComponent(formData.get('edu')) +
//            '&company=' + encodeURIComponent(formData.get('company')) +
//            '&email=' + encodeURIComponent(formData.get('email')) +
//            '&job=' + encodeURIComponent(formData.get('job')) +
//            '&jobnature=' + encodeURIComponent(formData.get('jobnature')) +
//            '&skills=' + encodeURIComponent(skills.join(',')); // Include skills
//        
...
//    // Modify this logic to match your skill format
//    var skillMatches = text.match(/(?:\s|^)([\w\s]+)(?:\s|,|$)/g);
//    if (skillMatches) {
//        return skillMatches.map(function(match) {
//            return match.trim();
//        });
//    }
//    return [];
