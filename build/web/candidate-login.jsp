            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-5 ">
                    <div class="appoinment-content">
                          <img src="assets/img/login.jpg" width="70%" height="0px"
             class="img-fluid ${condition ? 'rounded-circle' : ''}"
             alt="">
                ...
                <div class="col-lg-6 col-md-10 ">
                    <div class="appoinment-wrap mt-5 mt-lg-0 ">
                        ...
                        <form id="#" class="appoinment-form" method="post" action="candidate-login-action.jsp">
                            <div class="row">
                            ...
                            <button type="submit" class="btn btn-main btn-round-full"
                                style="color:white;border-radius: 30px;">Sign in<i
                                    class="icofont-simple-right ml-2  "></i></button>

                            <p>Don't have account? <a href="candidate-register.jsp" style="color:blue">Register
                                    here</a> </p>
