...
%>
    ...
    <section class="contact-section">
        <div class="container">
            <form  action="candidate-register-action.jsp" class="form-contact contact_form" method="post" enctype="multipart/form-data">
             ...
             alt="Login Image">
                    ...
                    <div class="col-lg-6 col-md-10 ">
                        <div class="appoinment-wrap mt-5 mt-lg-0 ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="cname" id="form1Example13" placeholder="Fullname"
                                            class="form-control form-control-lg"
                                            style="font-weight:bold;font-size:medium;border-radius: 10px;" required/>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-lg"
                                            ...
                                            name="image" id="formFileSm" type="file" required />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                            ...
                            <p>Already have account? <a href="candidate-login.jsp" style="color:blue">Login here</a>
                            </p>
