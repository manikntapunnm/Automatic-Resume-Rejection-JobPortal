...
<p>Email: <%= session.getAttribute("email") %></p>
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Company /</span>Feedback</h4>

            <div class="row ">


              <div class="container">
                  <form action="company-feedback-action.jsp" method="post"  id="ratingForm">
                      <div class="table-responsive pt-3">
                          ...
                          <table class="table table-striped table-bordered">
                              <thead>
                                  <tr>
                                      <th colspan="4">
                              <center>
                                  <h4 class="card-title" style="color: rgb(45, 62, 219);">Add Your Feedback</h4>
                              </center>
                              </th>
                              </tr>
                              </thead>
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      <td>
                                          <label for="rating1">1. How would you rate finding the Candidates in our site?</label>
                                      ...
                                      <td>
                                          <label for="rating2">2.How much do you rate in Hosting job post in our site?</label>
                                          <fieldset class="star-rating">
                                              <div class="star-rating__stars">
                          ...
                          <br>
                          <center><button type="submit" class="btn btn-main" style="background-color:rgb(12, 55, 116); color:white;">
