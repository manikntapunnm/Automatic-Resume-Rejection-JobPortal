      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manage /</span> Jobs</h4>
...
int totalRecords = 0;
    PreparedStatement countStatement = connection.prepareStatement(
        "SELECT COUNT(*) FROM applications WHERE email = ?");
...
//    ResultSet resultSet = statement.executeQuery();
 ...
 PreparedStatement statement = connection.prepareStatement("SELECT j.*, c.company, c.address, c.cimage, c.email FROM jobs j INNER JOIN company c ON j.companyid = c.companyid WHERE c.email = ? " +"LIMIT ?, ?");
...
ResultSet resultSet = statement.executeQuery();
  ...
  %>
            ...
            <!-- Responsive Table -->
            <div class="card">
              <h5 class="card-header">Manage Job</h5>
...
//String companyImageBase64 = new String(Base64.getEncoder().encode(companyImageBytes));
        ...
        %>      
                      ...
                      <tr>
            <td><%= Sno++ %></td>
            <td><img src="data:image/jpeg;base64,<%= companyImageBase64 %>"  width="50px" height="30px" alt="Company Image"></td>
            <td><%= companyName %></td>
            <td><%= companyLocation %></td>
            <td><%= salary %></td>
            <td><%= jobNature %></td>
            <td><%= officialEmail %></td>
            <td><textarea rows="2" cols="18"><%= Skills %></textarea></td>
            <td><textarea rows="2" cols="18"><%= Description %></textarea></td>
           
            <td><textarea rows="1" cols="18" ><%= experienceEducation %></textarea></td>
             <td><%= Status %></td>
                      <td><button type="button" class="btn-xs btn-primary"><a href="company-mangjob-edit.jsp?jobid=<%= resultSet.getString("jobid") %>"
                            style="color:white"> Edit</a></button>&nbsp;&nbsp;
                            <button type="button" class="btn-xs btn-danger"><a href="removeaction.jsp?jobid=<%= resultSet.getString("jobid") %>"
                            style="color:white"> Decline</a></button>
                      </tr>
