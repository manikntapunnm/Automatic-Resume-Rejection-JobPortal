...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Company /</span> Job Post</h4>

    <form action="company-mangjob-edit-action.jsp?jobid=<%=jobid%>" method="post"> <!-- Add form element with action and method -->
        ...
        <div class="row">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="jobNature" name="jobNature" aria-label="Default select example">
                                <option selected><%= resultSet.getString("jobnature") %></option>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="salary" name="salary" aria-label="Default select example">
                                <option selected><%= resultSet.getString("salary") %></option>
                        <option >250000 L - 400000 L</option>
                        <option >300000 L - 500000 L</option>
                        <option >500000 L - 800000 L</option>
                        <option >600000 L - 100000 L</option>
                            </select>
                        </div>

                        <div class="mb-3">
                            <label for="category" class="form-label">Category</label>
                            <select class="form-select" id="category" name="job" aria-label="Default select example">
                                   <option selected><%= resultSet.getString("job") %></option>
                        <option >Full Stack Python Developer</option>
                        <option >System Software Development</option>
                        <option >Research and code , APIs and frameworks</option>
                        ...
                        <option >Mobile Applicationin iOS/Android/Tizen or other platform</option>
                            </select>
                        </div>
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="mb-3">
                      <label for="experienceEducation" class="form-label">Experience + Education</label>
    <input type="text" class="form-control" id="experienceEducation" name="experienceEducation" placeholder="Enter experience and education" value="<%= resultSet.getString("experience_education") %>" >
                        </div>

                        <div class="mb-3">
                            <label for="skills" class="form-label">Skills</label>
                            <textarea class="form-control" id="skills" name="skills" rows="3"><%= resultSet.getString("skills") %></textarea>

                        </div>

                        <div class="mb-3">
                            <label for="jobDescription" class="form-label">Job Description</label>
                            <textarea class="form-control" id="skills" name="description" rows="3"><%= resultSet.getString("description") %></textarea>
