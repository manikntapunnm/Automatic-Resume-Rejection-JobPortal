...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <form action="company-postjob-action.jsp" method="post"> <!-- Add form element with action and method -->
    ...
    <input type="text" class="form-control" id="experienceEducation" name="experienceEducation" placeholder="Enter experience and education">
                        </div>
