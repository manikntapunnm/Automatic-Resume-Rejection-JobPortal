...
%>
    ...
    <section class="contact-section">
        <div class="container">
            <form action="company-register-action.jsp" class="form-contact contact_form" method="post" enctype="multipart/form-data">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 ">
                        <div class="appoinment-content">
                            <img src="assets/img/login.jpg" width="70%" height="auto"
             ...
             alt="Login Image">
                    ...
                    <div class="col-lg-6 col-md-10 ">
                        <div class="appoinment-wrap mt-5 mt-lg-0 ">
                            <h2 class="mb-3 title-color">Sign-up</h2>

                            <div class="row">

                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="company" id="form1Example13" placeholder="Companyname"
                                            class="form-control form-control-lg"
                                            style="font-weight:bold;font-size:medium;border-radius: 10px;" />

                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" name="email" id="form1Example13" placeholder="Email"
                                            class="form-control form-control-lg"
                                            style="font-weight:bold;font-size:medium;border-radius: 10px;" />
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="tel" name="phone" id="form1Example13" placeholder="Mobile"
                                            class="form-control form-control-lg"
                                            style="font-weight:bold;font-size:medium;border-radius: 10px;" />
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" name="address" id="form1Example13" placeholder="Address"
                                            class="form-control form-control-lg"
                                            style="font-weight:bold;font-size:medium;border-radius: 10px;" />
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="" style="font-size:medium">Company Image</label>

                                        <input class="form-control form-control-lg"
                                            style="font-weight:bold;font-size:medium;border-radius: 10px;"
                                            name="cimage" id="formFileSm" type="file" accept="image/jpeg,image/png" />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="">Company PanCard</label>

                                        <input class="form-control form-control-lg"
                                            style="font-weight:bold;font-size:medium;border-radius: 10px;"
                                            name="pimage" id="formFileSm" type="file" accept="image/jpeg,image/png" />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="">Register Document</label>
                                        <input class="form-control form-control-lg"
                                            style="font-weight:bold;font-size:medium;border-radius: 10px;"
                                            name="document" id="formFileSm" type="file" accept=".pdf,.doc,.docx" />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="password" name="password" id="form1Example13"
                            ...
                            <button type="submit" class="btn btn-main btn-round-full"
                                style="color:white;border-radius: 60px;;">Sign up<i
                                    class="icofont-simple-right ml-2  "></i></button>

                            <p>Already have account? <a href="company-login.jsp" style="color:blue">Login here</a> </p>
