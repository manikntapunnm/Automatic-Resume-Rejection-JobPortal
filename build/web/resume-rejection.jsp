      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Resume /</span> Rejection</h4>
              ...
              <div class="table-responsive text-nowrap">
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">1</th>
                      <td><img src="assets2/img/avatars/6.png" width="50px" height="30px" alt=""></td>
                      <td>Swapna</td>
                      <td>TCS</td>
                      <td>Hyderabad</td>
                      <td>250000 L - 400000 L</td>
                      <td>Full Time</td>
                      <td>Graduation</td>
                      <td>Rejected</td>
